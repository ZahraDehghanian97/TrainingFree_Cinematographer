...
export const SYSTEM_PROMPT = `You are a virtual cinematographer. Given a 3D scene description
...
${JSON.stringify(EXAMPLE_OUTPUT_2)}
`;
 ...
 * JSON blob.
 */
export function buildUserPrompt(environment: Record<string, unknown>): string {
  const promptText = typeof environment.prompt === "string" ? environment.prompt : "";
  return (
    "ENVIRONMENT:\n" +
